...
function parseSOSExcel(filePath) {
  ...
  if (stores.length > 0) console.log(`  Sample: ${stores[0].store_id} Make=${stores[0].make} Prod=${stores[0].production}`);
